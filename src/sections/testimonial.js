...
const data = [
  {
    id: 1,
    title: '"Exceptional Ad Targeting & Performance"',
    description:
      'Working with this agency has been a game-changer for our business. Their ability to target the right audience and drive conversions has exceeded our expectations.',
    avatar: Avatar1,
    name: 'Jenny Yellow',
